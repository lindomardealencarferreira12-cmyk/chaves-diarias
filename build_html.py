    ...
    <style>
        ...
        * {{ margin: 0; padding: 0; box-sizing: border-box; }}
        ...
        .portal-door {{
            ...
            background-image: url('epic_cross_door_1778107042325.png');
        ...
        .scroll-content p {{ color: #f2f2f2; font-size: 1.1rem; line-height: 1.6; text-shadow: 0 2px 10px rgba(0,0,0,0.8); margin-bottom: 2rem; background: rgba(0,0,0,0.4); padding: 35px; border-radius: 12px; border: 1px solid rgba(229, 192, 123, 0.1); backdrop-filter: blur(10px); text-align: left; }}
