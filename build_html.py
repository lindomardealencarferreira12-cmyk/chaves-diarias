    ...
    <style>
        ...
        * {{ margin: 0; padding: 0; box-sizing: border-box; }}
        ...
        .scroll-modal-container {{
            ...
            background-image: url('seamless_parchment_texture_1778108463499.png');
        ...
        .scroll-content p {{ 
            ...
            color: #0d0804; font-weight: 500; font-size: 1.5rem; line-height: 1.8; text-shadow: none; 
            margin-bottom: 2rem; background: transparent; padding: 0; 
            border: none; backdrop-filter: none; text-align: center; 
        }}
...
<body>
    ...
    <div class="scroll-modal-container">
        <div class="scroll-modal" data-lenis-prevent="true">
